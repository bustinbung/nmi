...
export function readFeedHeader(pbf, end) {
    return pbf.readFields(readFeedHeaderField, {gtfs_realtime_version: "", incrementality: 0, timestamp: 0}, end);
}
...
export function readTripUpdateStopTimeEvent(pbf, end) {
    return pbf.readFields(readTripUpdateStopTimeEventField, {delay: 0, time: 0, uncertainty: 0}, end);
}
...
export function readTripUpdateStopTimeUpdateStopTimeProperties(pbf, end) {
    return pbf.readFields(readTripUpdateStopTimeUpdateStopTimePropertiesField, {assigned_stop_id: ""}, end);
}
...
export function readTripUpdateTripProperties(pbf, end) {
    return pbf.readFields(readTripUpdateTripPropertiesField, {trip_id: "", start_date: "", start_time: "", shape_id: ""}, end);
}
