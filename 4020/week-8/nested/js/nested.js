...
document.querySelector('#asteroid').innerText = `The asteroid named ${asteroid.name} is between ${asteroid.estimated_diameter.miles.estimated_diameter_min} miles and ${asteroid.estimated_diameter.miles.estimated_diameter_max} miles wide, and will miss striking Earth by approximately ${asteroid.close_approach_data[0].miss_distance.miles} miles.`;

document.body.innerHTML += `<a href="${asteroid.links.self}">Link</a>`